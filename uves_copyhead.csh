...
# If a single chip is specified, define it here
if ($2 != "") then
  if ($2 != "redl" && $2 != "redu") then
    echo "$0"": FATAL ERROR: If you specify a single chip as"
    echo "  second argument, it must be either redl or redu."
    exit 0
  endif
endif
